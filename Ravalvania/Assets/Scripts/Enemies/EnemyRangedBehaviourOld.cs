 ...
 */
    ...
    public class EnemyRangedBehaviourOld : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            m_EnemyHitbox = this.transform.GetChild(0).gameObject;
        ...
        public void Shoot()
        {
            ...
            m_Bullet.transform.position = m_EnemyHitbox.transform.position;
